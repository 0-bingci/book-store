          ...
          {/* <div className="bg-white rounded-lg p-4 mb-6 card-shadow">
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <div className="w-full md:w-auto">
                <select
                  className="w-full md:w-auto px-4 py-2 border border-neutral-200 rounded-lg"
                  disabled
                >
                  <option value="all">加载分类中...</option>
                </select>
              </div>
            </div>
          </div> */}
          ...
          <>
            ...
            <div className="mt-10 flex justify-center items-center gap-2">
              ...
              <span className="text-neutral-500 text-sm ml-4">
                第 {searchParams.page} 页 / 共 {totalPages} 页（总 {totalCount}{" "}
                本）
              </span>
            </div>
          </>
